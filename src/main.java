...
public class main {
    ...
    /*Exercise 4 Obtain a list of products ordered by customer of tier 2 between 01-feb-2021
    and 01-April-2021 */
    ...
    /*Exercise 10 Obtain a collection of statistic figures (i.e. sum, average, max, min, count) for
    all products of category “Books” */
